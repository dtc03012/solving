...
int main(void)
{
	...
	for(int e=3+n;e<3+2*n;e++)
	{
		arr[e].push_back(3+2*n);
		arr[3+2*n].push_back(e);
		cap[e][3+2*n]=987654321;
	}
	int tot=0;
	while(1)
	{
		...
		if(parent[3+n*2]==-1) break;
		int amount=987654321;
		for(int e=3+n*2;e!=0;e=parent[e]) amount=min(amount,cap[parent[e]][e]-flow[parent[e]][e]);
		for(int e=3+n*2;e!=0;e=parent[e])
		{
